...
$mail->Subject = 'Заявка на консультацию у ' . $spec;
$mail->Body    = '<p>Имя: ' . $f_name . '</p><p>Телефон: '.$phone . '</p><p>Консультация у: ' .$spec.'</p><p>Сообщение: '.$message . '</p>';
$mail->AltBody = '';
...
<script>
	...
	fbq('init', '183143279045048');
	fbq('track', 'PageView');
</script><noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=869611096574211&ev=PageView&noscript=1" /></noscript><!-- End Facebook Pixel Code -->
        <!-- Facebook Pixel Code -->
<script>
	! function(f, b, e, v, n, t, s) {
		if (f.fbq) return;
